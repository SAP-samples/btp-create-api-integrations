...
1. Access the Application Development by selecting SAP Build Process Automation from your SAP BTP cockpit under **Instances and Subscriptions**.
...
4. Release process and retrieve definition id
    ...
    * Retrieve the definition id of the newly released process for use in the developer portal. This can be done either through the SAP Build Process Automation lobby under **Monitor > Manage > Processes and Workflows** or through the [Workflow definitions](https://api.sap.com/api/SAP_CP_Workflow_CF/resource) API.
