 ...
 */
export class GenericKeyMapEntries<
  ...
  implements GenericKeyMapEntriesType<T>
{
   ...
   */
  static _entityName = 'GenericKeyMapEntries';
  /**
   ...
   */
  static _keys = ['name', 'scope', 'scopeId'];
  /**
   * Is Encrypted.
   * @nullable
   */
  ...
  constructor(readonly _entityApi: GenericKeyMapEntriesApi<T>) {
    super(_entityApi);
  }
}
