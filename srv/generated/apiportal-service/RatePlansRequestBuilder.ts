 ...
 */
export class RatePlansRequestBuilder<
...
> extends RequestBuilder<RatePlans<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<RatePlans<T>, T>(this.entityApi, {
      id: id
    });
  }
  ...
  getAll(): GetAllRequestBuilder<RatePlans<T>, T> {
    return new GetAllRequestBuilder<RatePlans<T>, T>(this.entityApi);
  }
  ...
  create(entity: RatePlans<T>): CreateRequestBuilder<RatePlans<T>, T> {
    return new CreateRequestBuilder<RatePlans<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: RatePlans<T>): UpdateRequestBuilder<RatePlans<T>, T> {
    return new UpdateRequestBuilder<RatePlans<T>, T>(this.entityApi, entity);
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<RatePlans<T>, T> {
    return new DeleteRequestBuilder<RatePlans<T>, T>(
      this.entityApi,
      idOrEntity instanceof RatePlans ? idOrEntity : { id: idOrEntity! }
    );
  }
}
