 ...
 */
export class FileResourcesRequestBuilder<
...
> extends RequestBuilder<FileResources<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<FileResources<T>, T>(this.entityApi, {
      id: id
    });
  }
  ...
  getAll(): GetAllRequestBuilder<FileResources<T>, T> {
    return new GetAllRequestBuilder<FileResources<T>, T>(this.entityApi);
  }
  ...
  create(entity: FileResources<T>): CreateRequestBuilder<FileResources<T>, T> {
    return new CreateRequestBuilder<FileResources<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(entity: FileResources<T>): UpdateRequestBuilder<FileResources<T>, T> {
    return new UpdateRequestBuilder<FileResources<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<FileResources<T>, T> {
    return new DeleteRequestBuilder<FileResources<T>, T>(
      this.entityApi,
      idOrEntity instanceof FileResources ? idOrEntity : { id: idOrEntity! }
    );
  }
}
