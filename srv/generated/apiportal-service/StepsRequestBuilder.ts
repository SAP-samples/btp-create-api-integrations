 ...
 */
export class StepsRequestBuilder<
...
> extends RequestBuilder<Steps<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Steps<T>, T>(this.entityApi, { id: id });
  }
  ...
  getAll(): GetAllRequestBuilder<Steps<T>, T> {
    return new GetAllRequestBuilder<Steps<T>, T>(this.entityApi);
  }
  ...
  create(entity: Steps<T>): CreateRequestBuilder<Steps<T>, T> {
    return new CreateRequestBuilder<Steps<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Steps<T>): UpdateRequestBuilder<Steps<T>, T> {
    return new UpdateRequestBuilder<Steps<T>, T>(this.entityApi, entity);
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<Steps<T>, T> {
    return new DeleteRequestBuilder<Steps<T>, T>(
      this.entityApi,
      idOrEntity instanceof Steps ? idOrEntity : { id: idOrEntity! }
    );
  }
}
