 ...
 */
export class FlowRulesRequestBuilder<
...
> extends RequestBuilder<FlowRules<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<FlowRules<T>, T>(this.entityApi, {
      id: id
    });
  }
  ...
  getAll(): GetAllRequestBuilder<FlowRules<T>, T> {
    return new GetAllRequestBuilder<FlowRules<T>, T>(this.entityApi);
  }
  ...
  create(entity: FlowRules<T>): CreateRequestBuilder<FlowRules<T>, T> {
    return new CreateRequestBuilder<FlowRules<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: FlowRules<T>): UpdateRequestBuilder<FlowRules<T>, T> {
    return new UpdateRequestBuilder<FlowRules<T>, T>(this.entityApi, entity);
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<FlowRules<T>, T> {
    return new DeleteRequestBuilder<FlowRules<T>, T>(
      this.entityApi,
      idOrEntity instanceof FlowRules ? idOrEntity : { id: idOrEntity! }
    );
  }
}
