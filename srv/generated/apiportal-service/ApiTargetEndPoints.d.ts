 ...
 */
export declare class ApiTargetEndPoints<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ApiTargetEndPointsType<T>
{
  readonly _entityApi: ApiTargetEndPointsApi<T>;
  /**
  ...
  constructor(_entityApi: ApiTargetEndPointsApi<T>);
}
...
//# sourceMappingURL=ApiTargetEndPoints.d.ts.map
