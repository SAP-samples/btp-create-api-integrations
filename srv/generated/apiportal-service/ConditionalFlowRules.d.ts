 ...
 */
export declare class ConditionalFlowRules<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ConditionalFlowRulesType<T>
{
  readonly _entityApi: ConditionalFlowRulesApi<T>;
  /**
  ...
  constructor(_entityApi: ConditionalFlowRulesApi<T>);
}
...
//# sourceMappingURL=ConditionalFlowRules.d.ts.map
