 ...
 */
export declare class CacheResourcesRequestBuilder<
...
> extends RequestBuilder<CacheResources<T>, T> {
   ...
   */
  create(entity: CacheResources<T>): CreateRequestBuilder<CacheResources<T>, T>;
  /**
   ...
   */
  update(entity: CacheResources<T>): UpdateRequestBuilder<CacheResources<T>, T>;
  /**
...
//# sourceMappingURL=CacheResourcesRequestBuilder.d.ts.map
