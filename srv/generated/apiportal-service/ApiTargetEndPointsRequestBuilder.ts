 ...
 */
export class ApiTargetEndPointsRequestBuilder<
...
> extends RequestBuilder<ApiTargetEndPoints<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ApiTargetEndPoints<T>, T>(
      this.entityApi,
      { id: id }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<ApiTargetEndPoints<T>, T> {
    return new GetAllRequestBuilder<ApiTargetEndPoints<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ApiTargetEndPoints<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<ApiTargetEndPoints<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<ApiTargetEndPoints<T>, T> {
    return new DeleteRequestBuilder<ApiTargetEndPoints<T>, T>(
      this.entityApi,
      idOrEntity instanceof ApiTargetEndPoints
        ? idOrEntity
        : { id: idOrEntity! }
    );
  }
