 ...
 */
export declare class ApiProducts<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ApiProductsType<T>
{
  readonly _entityApi: ApiProductsApi<T>;
  /**
  ...
  constructor(_entityApi: ApiProductsApi<T>);
}
...
//# sourceMappingURL=ApiProducts.d.ts.map
