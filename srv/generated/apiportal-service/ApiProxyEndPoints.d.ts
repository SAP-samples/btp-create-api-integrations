 ...
 */
export declare class ApiProxyEndPoints<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ApiProxyEndPointsType<T>
{
  readonly _entityApi: ApiProxyEndPointsApi<T>;
  /**
  ...
  constructor(_entityApi: ApiProxyEndPointsApi<T>);
}
...
//# sourceMappingURL=ApiProxyEndPoints.d.ts.map
