 ...
 */
export class DestinationAndUrlMappingsRequestBuilder<
...
> extends RequestBuilder<DestinationAndUrlMappings<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<DestinationAndUrlMappings<T>, T>(
      this.entityApi,
      { id: id }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<DestinationAndUrlMappings<T>, T> {
    return new GetAllRequestBuilder<DestinationAndUrlMappings<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<DestinationAndUrlMappings<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<DestinationAndUrlMappings<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<DestinationAndUrlMappings<T>, T>(
      this.entityApi,
      idOrEntity instanceof DestinationAndUrlMappings
        ? idOrEntity
        : { id: idOrEntity! }
    );
  }
