 ...
 */
export class AclProductLinkagesRequestBuilder<
...
> extends RequestBuilder<AclProductLinkages<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AclProductLinkages<T>, T>(
      this.entityApi,
      { ruleId: ruleId }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<AclProductLinkages<T>, T> {
    return new GetAllRequestBuilder<AclProductLinkages<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<AclProductLinkages<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<AclProductLinkages<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(ruleIdOrEntity: any): DeleteRequestBuilder<AclProductLinkages<T>, T> {
    return new DeleteRequestBuilder<AclProductLinkages<T>, T>(
      this.entityApi,
      ruleIdOrEntity instanceof AclProductLinkages
        ? ruleIdOrEntity
