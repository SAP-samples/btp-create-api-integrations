 ...
 */
export class EndPointProperties<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements EndPointPropertiesType<T>
{
   ...
   */
  static _entityName = 'EndPointProperties';
  /**
  ...
  constructor(readonly _entityApi: EndPointPropertiesApi<T>) {
    super(_entityApi);
  }
}
