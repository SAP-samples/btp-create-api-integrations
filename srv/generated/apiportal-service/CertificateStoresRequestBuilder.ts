 ...
 */
export class CertificateStoresRequestBuilder<
...
> extends RequestBuilder<CertificateStores<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<CertificateStores<T>, T>(this.entityApi, {
      name: name
    });
  }
  ...
  getAll(): GetAllRequestBuilder<CertificateStores<T>, T> {
    return new GetAllRequestBuilder<CertificateStores<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<CertificateStores<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<CertificateStores<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(nameOrEntity: any): DeleteRequestBuilder<CertificateStores<T>, T> {
    return new DeleteRequestBuilder<CertificateStores<T>, T>(
      this.entityApi,
      nameOrEntity instanceof CertificateStores
        ? nameOrEntity
        : { name: nameOrEntity! }
    );
  }
