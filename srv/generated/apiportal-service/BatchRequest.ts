...
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteApiportalServiceRequestBuilder<DeSerializersT>
    | Array<WriteApiportalServiceRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteApiportalServiceRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
