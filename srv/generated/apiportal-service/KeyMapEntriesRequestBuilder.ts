 ...
 */
export class KeyMapEntriesRequestBuilder<
...
> extends RequestBuilder<KeyMapEntries<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<KeyMapEntries<T>, T>(this.entityApi, {
      name: name
    });
  }
  ...
  getAll(): GetAllRequestBuilder<KeyMapEntries<T>, T> {
    return new GetAllRequestBuilder<KeyMapEntries<T>, T>(this.entityApi);
  }
  ...
  create(entity: KeyMapEntries<T>): CreateRequestBuilder<KeyMapEntries<T>, T> {
    return new CreateRequestBuilder<KeyMapEntries<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(entity: KeyMapEntries<T>): UpdateRequestBuilder<KeyMapEntries<T>, T> {
    return new UpdateRequestBuilder<KeyMapEntries<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(nameOrEntity: any): DeleteRequestBuilder<KeyMapEntries<T>, T> {
    return new DeleteRequestBuilder<KeyMapEntries<T>, T>(
      this.entityApi,
      nameOrEntity instanceof KeyMapEntries
        ? nameOrEntity
        : { name: nameOrEntity! }
    );
  }
