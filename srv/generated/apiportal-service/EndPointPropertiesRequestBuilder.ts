 ...
 */
export class EndPointPropertiesRequestBuilder<
...
> extends RequestBuilder<EndPointProperties<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<EndPointProperties<T>, T>(
      this.entityApi,
      { id: id }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<EndPointProperties<T>, T> {
    return new GetAllRequestBuilder<EndPointProperties<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<EndPointProperties<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<EndPointProperties<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<EndPointProperties<T>, T> {
    return new DeleteRequestBuilder<EndPointProperties<T>, T>(
      this.entityApi,
      idOrEntity instanceof EndPointProperties
        ? idOrEntity
        : { id: idOrEntity! }
    );
  }
