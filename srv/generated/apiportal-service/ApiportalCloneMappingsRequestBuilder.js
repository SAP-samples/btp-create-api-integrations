...
exports.ApiportalCloneMappingsRequestBuilder = void 0;
/*
 ...
 */
class ApiportalCloneMappingsRequestBuilder extends odata_v2_1.RequestBuilder {
    /**
     ...
     */
    getByKey(subaccountId) {
        return new odata_v2_1.GetByKeyRequestBuilder(this.entityApi, { subaccountId: subaccountId });
    }
    /**
    ...
    delete(subaccountIdOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, subaccountIdOrEntity instanceof ApiportalCloneMappings_1.ApiportalCloneMappings
            ? subaccountIdOrEntity
            : { subaccountId: subaccountIdOrEntity });
    }
}
exports.ApiportalCloneMappingsRequestBuilder = ApiportalCloneMappingsRequestBuilder;
//# sourceMappingURL=ApiportalCloneMappingsRequestBuilder.js.map