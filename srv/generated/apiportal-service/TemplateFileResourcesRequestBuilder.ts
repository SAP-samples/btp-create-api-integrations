 ...
 */
export class TemplateFileResourcesRequestBuilder<
...
> extends RequestBuilder<TemplateFileResources<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<TemplateFileResources<T>, T>(
      this.entityApi,
      { id: id }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<TemplateFileResources<T>, T> {
    return new GetAllRequestBuilder<TemplateFileResources<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<TemplateFileResources<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<TemplateFileResources<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<TemplateFileResources<T>, T> {
    return new DeleteRequestBuilder<TemplateFileResources<T>, T>(
      this.entityApi,
      idOrEntity instanceof TemplateFileResources
        ? idOrEntity
        : { id: idOrEntity! }
    );
  }
