 ...
 */
export class DevelopersRequestBuilder<
...
> extends RequestBuilder<Developers<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Developers<T>, T>(this.entityApi, {
      id: id
    });
  }
  ...
  getAll(): GetAllRequestBuilder<Developers<T>, T> {
    return new GetAllRequestBuilder<Developers<T>, T>(this.entityApi);
  }
  ...
  create(entity: Developers<T>): CreateRequestBuilder<Developers<T>, T> {
    return new CreateRequestBuilder<Developers<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: Developers<T>): UpdateRequestBuilder<Developers<T>, T> {
    return new UpdateRequestBuilder<Developers<T>, T>(this.entityApi, entity);
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<Developers<T>, T> {
    return new DeleteRequestBuilder<Developers<T>, T>(
      this.entityApi,
      idOrEntity instanceof Developers ? idOrEntity : { id: idOrEntity! }
    );
  }
}
