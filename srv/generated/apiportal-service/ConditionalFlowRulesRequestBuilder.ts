 ...
 */
export class ConditionalFlowRulesRequestBuilder<
...
> extends RequestBuilder<ConditionalFlowRules<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ConditionalFlowRules<T>, T>(
      this.entityApi,
      { id: id }
    );
  }
  ...
  getAll(): GetAllRequestBuilder<ConditionalFlowRules<T>, T> {
    return new GetAllRequestBuilder<ConditionalFlowRules<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<ConditionalFlowRules<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<ConditionalFlowRules<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(idOrEntity: any): DeleteRequestBuilder<ConditionalFlowRules<T>, T> {
    return new DeleteRequestBuilder<ConditionalFlowRules<T>, T>(
      this.entityApi,
      idOrEntity instanceof ConditionalFlowRules
        ? idOrEntity
        : { id: idOrEntity! }
    );
  }
