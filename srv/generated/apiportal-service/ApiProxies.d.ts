 ...
 */
export declare class ApiProxies<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements ApiProxiesType<T>
{
  readonly _entityApi: ApiProxiesApi<T>;
  /**
  ...
  constructor(_entityApi: ApiProxiesApi<T>);
}
...
//# sourceMappingURL=ApiProxies.d.ts.map
